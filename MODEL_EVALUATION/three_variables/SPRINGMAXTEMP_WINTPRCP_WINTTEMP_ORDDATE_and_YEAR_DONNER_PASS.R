...
bb<-as.matrix(cbind(stand(sub_dat$spring_tmax), stand(sub_dat$winter_prcp), stand(sub_dat$winter_tmin), stand(sub_dat$ordDate),
...
save(list=ls(),file=paste("SPRINGMAXTEMP_WINTPRCP_WINTTEMP_ORDDATE_and_YEAR_",sites[j],".rdat",sep=""))
