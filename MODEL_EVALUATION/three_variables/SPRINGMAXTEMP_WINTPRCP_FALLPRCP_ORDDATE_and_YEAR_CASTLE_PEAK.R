...
bb<-as.matrix(cbind(stand(sub_dat$spring_tmax), stand(sub_dat$winter_prcp), stand(sub_dat$prevfall_prcp), stand(sub_dat$ordDate),
...
save(list=ls(),file=paste("SPRINGMAXTEMP_WINTPRCP_FALLPRCP_ORDDATE_and_YEAR_",sites[j],".rdat",sep=""))
