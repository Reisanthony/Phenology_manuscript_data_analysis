...
bb<-as.matrix(cbind(stand(sub_dat$spring_tmax), stand(sub_dat$winter_prcp), stand(sub_dat$prevfall_tmin), stand(sub_dat$ordDate),
...
save(list=ls(),file=paste("SPRINGMAXTEMP_WINTPRCP_FALLTEMP_ORDDATE_and_YEAR_",sites[j],".rdat",sep=""))
